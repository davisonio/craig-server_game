...
minetest.register_chatcommand("seen", {
	params = "<name>",
	description = "Find out when a player was last seen on the server.",
	func = function(name, param)
		...
		if param ~= nil and param ~= "" then
			if seens[param] ~= nil then
				...
				minetest.chat_send_player(name, "There is no record of "..param..". Maybe you misspelled their name?")
			end
		end
	end,
})
