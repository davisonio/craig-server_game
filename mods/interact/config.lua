...
interact.s3_interact_msg1 = "Thanks for accepting the rules, you now are able to build (interact)."
...
interact.s3_disagree_msg = "Sorry, you have to agree in order to build (interact). Type /rules if you change your mind."
